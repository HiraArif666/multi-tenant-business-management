...
const TYPE_NAME = 'Contractor';

@ApiTags('Master Data - Contractors')
@ApiBearerAuth()
...
export class ContractorsController {
  ...
  @ApiOperation({ summary: 'Get Contractors' })
  ...
  @Post()
  @HasPermission('master-data.contractor.add')
  ...
  @Put(':id')
  @HasPermission('master-data.contractor.edit')
  ...
  @Delete(':id')
  @HasPermission('master-data.contractor.delete')
